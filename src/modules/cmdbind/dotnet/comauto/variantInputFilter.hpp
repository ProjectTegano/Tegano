...
{
public:
	VariantInputFilter( const comauto::TypeLib* typelib_, const ITypeInfo* typeinfo_, VARIANT data_, serialize::ValidationFlags::Enum flags_);
...
private:
	...
	serialize::ValidationFlags::Enum m_flags;
	bool m_done;
};
