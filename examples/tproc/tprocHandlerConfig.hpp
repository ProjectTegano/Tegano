...
public:
	...
	const std::vector<cmdbind::ExecProtocolHandler::Command>& commands() const	{return m_commands;}

private:
	std::vector<cmdbind::ExecProtocolHandler::Command> m_commands;			//< command definitions
